...
class QuotationsControllerTest < ActionController::TestCase
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post :create, quotation: { author_id: @quotation.author_id, content: @quotation.content, topic: @quotation.topic }
    end
  ...
  test "should update quotation" do
    patch :update, id: @quotation, quotation: { author_id: @quotation.author_id, content: @quotation.content, topic: @quotation.topic }
    assert_redirected_to quotation_path(assigns(:quotation))
  end
